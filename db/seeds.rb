...
doula11 = User.create!(name: "Carrie", username: "Carrie1", last_initial: "K", password: 'password', picture: "http://localhost:3000/doula20.png", available_date: '2021-01-08', specialty: "Spinning Babies", certified: true, birth_doula: true, postpartum_doula: true,county_1: "Alameda", county_2: "Marin", county_3: "Santa Clara", birthday: '1988-07-08', price: "$", is_doula: true, preferred_apt_time: '180000', previous_births: 6, homebirth: false, hospital_birth: false, birthcenter: true, bio: "I have been working alongside my friend who is a midwife at a birth center. I have experienced 6 births and am very excited to work with you to have a magical birth experience.")

doula12 = User.create!(name: "Melissa", username: "Mel1", last_initial: "P", password: 'password', picture: "http://localhost:3000/doula21.png", available_date: '2021-01-08', bio: "I love being a doula! I am so excited to meet your family and have the birth you truly want. Book an appointment and let's see what we can create.", specialty: "Spinning Babies", certified: true, birth_doula: true, postpartum_doula: true,county_1: "Alameda", county_2: "Marin", county_3: "Santa Clara", birthday: '1988-07-08', price: "$", is_doula: true, preferred_apt_time: '180000', previous_births: 10, homebirth: true, hospital_birth: true, birthcenter: true)

doula13 = User.create!(name: "Britney", username: "Britt112", last_initial: "L", password: 'password', picture: "http://localhost:3000/doula22.png", available_date: '2021-01-08', bio: "I have been to a few births and they have gone swimmingly. One of the mothers told me she was not aware of how valuable a doula was to the birth experience. She previously had an unplanned cesarean section, and with my help we were able to achieve a healthy unmedicated second birth.", specialty: "Accupressure", certified: true, birth_doula: true, postpartum_doula: true,county_1: "Alameda", county_2: "Marin", county_3: "Santa Clara", birthday: '1988-07-08', price: "$", is_doula: true, preferred_apt_time: '180000', previous_births: 3)

doula14 = User.create!(name: "Faye", username: "Faye112", last_initial: "E", password: 'password', picture: "http://localhost:3000/doula23.png", available_date: '2021-01-08', bio: "I am an up and coming doula. I offer a reasonable price because I am hungry to learn and I want to help as many mothers as I can.", specialty: "Hypnobirthing", certified: true, birth_doula: true, postpartum_doula: true,county_1: "Alameda", county_2: "Marin", county_3: "Santa Clara", birthday: '1988-07-08', price: "$", is_doula: true, preferred_apt_time: '180000', previous_births: 1)
